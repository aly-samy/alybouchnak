...
export const albums: Album[] = [
  {
    ...
    educationalBenefits: [
      { title: 'Language Development', description: 'Supports vocabulary growth through repetitive lyrics and catchy melodies.' },
      { title: 'Motor Skills', description: 'Encourages movement and coordination through dance and action songs.' },
      { title: 'Social Skills', description: 'Promotes sharing and interaction through group music activities.' },
      { title: 'Emotional Expression', description: 'Helps children express feelings through music and movement.' }
    ],
...
5. Family-Centered Design\nMany tracks include elements that encourage family participation:\n• Call-and-response formats\n• Simple choreography for group activities\n• Relatable family scenarios\n• Inclusive language for diverse family structures`,
    tracks: [
      ...
      { number: 5, title: 'The Yummy Spoon (Open Wide)', duration: '2:20', description: 'Mealtime encouragement song that makes eating fun and reduces picky eating.', mood: 'Gentle', slug: 'the-yummy-spoon' },
      { number: 6, title: 'The Alphabet Song', duration: '2:55', description: 'Educational alphabet learning song with catchy melody and rhythm.', mood: 'Educational', slug: 'alphabet-song' },
      { number: 7, title: 'Nanny & Papa (Funny Bunny Family)', duration: '3:15', description: 'Heartwarming family celebration song about grandparent relationships.', mood: 'Loving', slug: 'nanny-papa' },
      { number: 8, title: 'The Duckie Song', duration: '2:30', description: 'Fun animal sound song featuring duck calls and water-themed actions.', mood: 'Quirky', slug: 'duckie-song' },
      { number: 9, title: 'Pet-Pop | The Animal Song', duration: '2:50', description: 'Interactive animal identification song with various pet sounds and movements.', mood: 'Adventurous', slug: 'pet-pop-animal-song' },
  ...
  },
  {
    ...
    amazonUrl: 'https://amazon.com/music/player/artists/B0FVYF53CC/aly-bouchnak',
    educationalBenefits: [
      { title: 'Cultural Literacy', description: 'Introduces children to classic songs and cultural heritage.' },
      { title: 'Physical Activity', description: 'Promotes active play and exercise through dance and movement.' },
      { title: 'Musical Appreciation', description: 'Develops rhythm and timing through upbeat party music.' },
      { title: 'Social Celebration', description: 'Creates joyful shared experiences for groups and families.' }
    ],
...
5. Cross-Generational Appeal\nModern production of classic songs creates:\n• Bridge between generations (parents, grandparents, children)\n• Shared cultural experience\n• Nostalgia with contemporary relevance\n• Family tradition building opportunities`,
    tracks: [
      { number: 1, title: 'Old MacDonald Had a Farm (Farm Party)', duration: '2:45', description: 'High-energy farm animal song with modern pop production and dance-friendly rhythm.', mood: 'Energetic', slug: 'old-macdonald-farm-party' },
      { number: 2, title: 'The Wheels on the Bus (Party Ride)', duration: '3:10', description: 'Upbeat transportation song with driving rhythm and party energy.', mood: 'Exciting', slug: 'wheels-on-the-bus-party-ride' },
      { number: 3, title: 'Five Little Monkeys (Jungle Party)', duration: '2:55', description: 'Playful counting song with jungle beats and monkey-themed actions.', mood: 'Playful', slug: 'five-little-monkeys-jungle-party' },
      { number: 4, title: 'Twinkle Twinkle Little Star (Dreamy Version)', duration: '2:30', description: 'Gentle lullaby with modern ambient production and dreamy atmosphere.', mood: 'Dreamy', slug: 'twinkle-twinkle-dreamy' },
      { number: 5, title: 'Row Row Row Your Boat (Gentle Journey)', duration: '2:20', description: 'Calming boat journey song with soothing harmonies and gentle rhythm.', mood: 'Peaceful', slug: 'row-row-boat' },
      { number: 6, title: 'Itsy Bitsy Spider (Climbing Time)', duration: '2:40', description: 'Upbeat spider climbing song with energetic rhythm and fun actions.', mood: 'Adventurous', slug: 'itsy-bitsy-spider' },
      { number: 7, title: 'The ABC Song (Pop Learning)', duration: '2:15', description: 'Modern alphabet learning song with catchy pop melody and rhythm.', mood: 'Educational', slug: 'alphabet-song' },
      { number: 8, title: 'Head Shoulders Knees and Toes (Movement Fun)', duration: '2:25', description: 'Interactive body parts song with movement actions and dance-friendly beat.', mood: 'Interactive', slug: 'body-party-head-shoulders' },
      { number: 9, title: "If You're Happy and You Know It (Clap Along)", duration: '2:50', description: 'Joyful clapping song with infectious rhythm and group participation.', mood: 'Joyful', slug: 'happy-party-edition' },
      { number: 10, title: 'Baby Shark (Dance Party)', duration: '2:35', description: 'High-energy shark-themed dance song with modern pop production.', mood: 'Wild', slug: 'baby-shark-party' },
      { number: 11, title: 'The Itsy Bitsy Spider (Rock Version)', duration: '3:05', description: 'Rock version of the spider song with electric guitars and driving beat.', mood: 'Rocking', slug: 'itsy-bitsy-rock' },
    ...
    type: 'Album',
    date: 'Feb 1, 2026',
    image: '/images/blooms-house-classics-party-cover.webp',
  ...
  },
  {
    ...
    educationalBenefits: [
      ...
      { title: 'Self-Soothing', description: 'Helps children develop independent sleep skills and coping mechanisms.' },
      { title: 'Nervous System Regulation', description: 'Supports healthy development through calming auditory input.' }
    ],
...
5. The Cumulative Effect\nEach track builds on the previous one. The album is designed to be listened to in sequence, creating a 25-minute journey from wakefulness to deep sleep. The full album is more effective than individual tracks.`,
    tracks: [
      { number: 1, title: 'The Safe Container', duration: '3:30', description: 'Validation track using Motherese timbres to signal safety and lower cortisol.', mood: 'Reassuring', slug: 'safe-container-calm-bedtime' },
      { number: 2, title: 'The Pendulum', duration: '4:00', description: 'Uses rhythmic patterns to mimic the vestibular stimulation of rocking or swaying.', mood: 'Gentle motion', slug: 'pendulum-rocking-lullaby' },
      { number: 3, title: 'The Sacred Shush', duration: '5:00', description: 'Features rhythmic white noise and sibilant sounds for psychoacoustic masking of startle reflexes.', mood: 'Protective', slug: 'sacred-shush-baby-shusher' },
      { number: 4, title: 'The Ancient Tongue', duration: '6:00', description: 'Uses humming frequencies to promote physical and emotional calm through resonance.', mood: 'Transcendent', slug: 'ancient-tongue-deep-sleep-humming' },
      { number: 5, title: 'The Infinite Loop', duration: '8:00', description: 'Seamless looping music designed for continuous play throughout the night.', mood: 'Timeless', slug: 'infinite-loop-continuous-sleep-aid' },
      { number: 6, title: 'The Protective Shadow', duration: '7:00', description: 'A social safety cue using low-register tones for harmonic stability and security.', mood: 'Grounding', slug: 'protective-shadow-night-drone' },
      { number: 7, title: 'The Liquid Room', duration: '10:00', description: 'Simulates the prenatal state using Brown Noise to mimic the amniotic sac environment.', mood: 'Prenatal', slug: 'liquid-room-brown-noise-womb' },
      { number: 8, title: 'The Dimming Light', duration: '4:30', description: 'Gradually fading melodies that mimic sunset, helping transition naturally to sleepiness.', mood: 'Fading', slug: 'dimming-light-soft-sleepy-music' }
    ],
    relatedAlbums: [
      { id: 1, title: "The Bloom's House: Volume 1", cover: '/images/the-blooms-house-volume-1-cover.webp', description: 'Original songs for daily routines', link: '#/album/the-blooms-house-volume-1' },
      { id: 2, title: "The Bloom's House: Classics Party", cover: '/images/the-blooms-house-classics-party-cover.webp', description: "Classic children's songs with modern twist", link: '#/album/the-blooms-house-classics-party' }
