...
5. The Cumulative Effect\nEach track builds on the previous one. The album is designed to be listened to in sequence, creating a 25-minute journey from wakefulness to deep sleep. The full album is more effective than individual tracks.`,
    tracks: [
      { number: 1, title: 'The Safe Container', duration: '2:44', description: 'Validation track using Motherese timbres to signal safety and lower cortisol.', mood: 'Reassuring', slug: 'safe-container-calm-bedtime' },
      { number: 2, title: 'The Pendulum', duration: '2:50', description: 'Uses rhythmic patterns to mimic the vestibular stimulation of rocking or swaying.', mood: 'Gentle motion', slug: 'pendulum-rocking-lullaby' },
      { number: 3, title: 'The Sacred Shush', duration: '2:45', description: 'Features rhythmic white noise and sibilant sounds for psychoacoustic masking of startle reflexes.', mood: 'Protective', slug: 'sacred-shush-baby-shusher' },
      { number: 4, title: 'The Ancient Tongue', duration: '3:52', description: 'Uses humming frequencies to promote physical and emotional calm through resonance.', mood: 'Transcendent', slug: 'ancient-tongue-deep-sleep-humming' },
      { number: 5, title: 'The Infinite Loop', duration: '3:32', description: 'Seamless looping music designed for continuous play throughout the night.', mood: 'Timeless', slug: 'infinite-loop-continuous-sleep-aid' },
      { number: 6, title: 'The Protective Shadow', duration: '2:45', description: 'A social safety cue using low-register tones for harmonic stability and security.', mood: 'Grounding', slug: 'protective-shadow-night-drone' },
      { number: 7, title: 'The Liquid Room', duration: '3:53', description: 'Simulates the prenatal state using Brown Noise to mimic the amniotic sac environment.', mood: 'Prenatal', slug: 'liquid-room-brown-noise-womb' },
