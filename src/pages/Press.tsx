...
const Press = () => {
    ...
    const featuredArticle = pressArticles.length > 0 ? pressArticles[0] : null;
    const gridArticles = featuredArticle ? pressArticles.slice(1) : pressArticles;

    const schemaData = {
        '@context': 'https://schema.org',
        '@type': 'CollectionPage',
        name: 'Press Coverage | Aly Bouchnak',
        description: 'Press coverage, media features, and news about Aly Bouchnak and The Bloom\'s House.',
        url: 'https://alybouchnak.com/press'
    };

    return (
        <div className="relative min-h-screen bg-slate-50">
            <SEO
                title="Press Coverage | Aly Bouchnak"
                description="Press coverage, media features, and news about Aly Bouchnak and The Bloom's House."
                keywords="Aly Bouchnak press, The Bloom's House media, children's music press coverage"
                canonical="https://alybouchnak.com/press"
                ogType="website"
            ...
            <div className="pt-32 pb-16 bg-white border-b border-gray-100">
                <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 text-center">
                    ...
                    <p className="text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto">
                        Media features, interviews, and news coverage of Aly Bouchnak & The Bloom's House.
                    </p>
                </div>
            </div>
            ...
            <section className="py-12 lg:py-16">
                <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 max-w-7xl mx-auto">
                    {pressArticles.length === 0 && (
                        <p className="text-center text-slate-500 py-20 text-lg">No press articles available yet. Stay tuned!</p>
                    )}
