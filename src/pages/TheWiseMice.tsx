...
// Track data for The Wise Mice
const trackData = {
  title: 'The Wise Mice',
  subtitle: 'Memory and sequencing skill builder (Ages 3–7)',
  description: 'Master memory and sequencing with this cumulative dance track. Designed to build cognitive skills through progressive pattern learning and recall exercises.',
  coverImage: '/images/the-wise-mice-cover.webp',
  artist: 'Aly Bouchnak',
  releaseDate: '2026-02-11',
  duration: '2:45',
  bpm: 118,
  genre: "Children's Pop, Educational Music",
  ageRange: '3-7 years',
  mood: 'Educational',
  routine: 'Learning Time',
  isrc: 'GXF972564747',
  album: 'The Wise Mice (EP)',
  spotifyUrl: 'https://push.fm/fl/the-wise-mice',
  ...
  deezerUrl: '#',
  lyrics: `The wise mice went to the market
The wise mice went to the market
To buy some cheese so yellow and bright

The wise mice went to the market
The wise mice went to the market
To buy some cheese so yellow and bright
And a little loaf of bread so white

The wise mice went to the forest
The wise mice went to the forest
To buy some cheese so yellow and bright
And a little loaf of bread so white
And some berries red and sweet

The wise mice went to the river
The wise mice went to the river
To buy some cheese so yellow and bright
And a little loaf of bread so white
And some berries red and sweet
And some water cool and fresh

The wise mice went back home
The wise mice went back home
With cheese so yellow and bright
And a little loaf of bread so white
And some berries red and sweet
And some water cool and fresh
And a warm bed for the night!`,
  artistNote: `I created "The Wise Mice" after watching children struggle with traditional memory games. Many memory exercises feel like tests rather than play. I wanted to create something that would build working memory skills through the joy of music and storytelling.

This song addresses a crucial developmental need: strengthening working memory and sequential thinking. The cumulative structure—where each verse adds a new item while remembering the previous ones—is a time-tested method for building memory capacity that's been used in folk traditions for centuries.

Parents tell me they use this song during:
• Quiet learning time when focus is needed
• Car rides to keep children engaged constructively
• Pre-bedtime wind-down activities
• Homeschooling sessions for memory skill building

The "wise mice" characters were chosen because mice are often portrayed as clever and resourceful in children's literature. The shopping narrative provides a relatable context that helps children create mental images to support their memory—visualizing the mice collecting items helps cement the sequence in their minds.`,
  scienceInsight: `The Science Behind Sequential Learning

"The Wise Mice" is built on cognitive psychology and educational neuroscience principles:

1. Working Memory Development
The cumulative structure directly exercises working memory—the brain's ability to hold and manipulate information temporarily. Each verse requires children to maintain previous items while adding new ones, progressively expanding their memory capacity. Research shows that working memory at ages 3-7 strongly predicts later academic success.

2. Sequential Processing
The song builds neural pathways for sequential thinking, a foundational skill for reading, mathematics, and problem-solving. The predictable pattern (adding one item per verse) helps children understand the concept of ordered sequences, which is essential for following multi-step instructions.

3. Chunking Strategy
The song naturally teaches "chunking"—breaking information into manageable groups. Children learn to remember items as categories (food items, locations, etc.), which is a sophisticated memory strategy used by adults. This skill transfers to academic learning like memorizing spelling words or math facts.

4. Auditory Processing & Recall
The musical setting enhances memory formation through multiple learning channels: auditory (hearing the words), rhythmic (feeling the beat), and melodic (singing the tune). This multi-sensory approach creates stronger neural connections than verbal repetition alone.

Cognitive Load Management
The 118 BPM tempo is deliberately slower than more active songs, reducing cognitive load and allowing children to focus on the memory task rather than complex motor movements. The gradual complexity increase respects developmental readiness—each new item is added only after previous ones are established.`,
  relatedTracks: [
    {
      id: 1,
...
const trackSchema = {
  ...
  duration: 'PT2M45S',
  isrcCode: 'GXF972564747',
  datePublished: '2026-02-11',
  genre: ["Children's Pop", 'Educational Music', 'Memory Building'],
  description: 'Master memory and sequencing with this cumulative dance track. Designed to build cognitive skills through progressive pattern learning and recall exercises.',
  ...
  inAlbum: {
    '@type': 'MusicAlbum',
    name: 'The Wise Mice',
    '@id': 'https://alybouchnak.com/album/the-wise-mice',
  },
  potentialAction: {
    '@type': 'ListenAction',
    target: 'https://push.fm/fl/the-wise-mice',
  },
  audience: {
    '@type': 'PeopleAudience',
    suggestedMinAge: '3',
  ...
  return (
    <div className="relative min-h-screen bg-[#C8F0F7]">
      <SEO
        ...
        keywords="The Wise Mice, memory songs for kids, cumulative songs for children, educational music for toddlers, Aly Bouchnak"
            ...
            <section className="content-section">
              <div className="bg-[#F7E859] rounded-3xl p-8 sm:p-12 text-center">
                <h2 className="font-['Fredoka_One'] text-2xl sm:text-3xl text-[#101010] mb-4">
                  Explore More Educational Songs
                </h2>
                <p className="text-[#2A2A2A] mb-6 max-w-xl mx-auto">
                  Discover our full collection of tracks designed to make learning fun, engaging, and effective for your child's development.
                </p>
                <a
                  href="/#/discography"
